...
architecture mapping of Application is
    ...
    constant AXIL_RING_INDEX_BASE_C   : natural := 1;  -- Must accomodate NUM_ADC_CH_C channels
    ...
    -- Local revolution signal. This can be the forwarded 'true' input from
    -- accelerator controls or a dummy signal generated by revSigCtrl.
    signal revSig : sl := '0';
...
begin
    ...
    genAxiStreamRingBuffers : for i in 0 to 1 generate
        U_AxiStreamRingBuffer : entity surf.AxiStreamRingBuffer
            ...
            port map (
                ...
                axilClk         => axilClk,
                axilRst         => axilRst,
                axilReadMaster  => axilReadMasters(AXIL_RING_INDEX_BASE_C + i),
                axilReadSlave   => axilReadSlaves(AXIL_RING_INDEX_BASE_C + i),
                axilWriteMaster => axilWriteMasters(AXIL_RING_INDEX_BASE_C + i),
                axilWriteSlave  => axilWriteSlaves(AXIL_RING_INDEX_BASE_C + i),
    ...
    U_RevSigCtrl : entity work.RevSigCtrl
        ...
        port map(
            ...
            revIn           => revSigIn,
            revOut          => revSig,
            revOutDiv       => open,  -- Pulse output every n cycles (divider is register)
            -- AXI-Lite Interface
            axilClk         => axilClk,
            axilRst         => axilRst,
            axilReadMaster  => axilReadMasters(AXIL_REVSIG_CTRL_INDEX_C),
            axilReadSlave   => axilReadSlaves(AXIL_REVSIG_CTRL_INDEX_C),
            axilWriteMaster => axilWriteMasters(AXIL_REVSIG_CTRL_INDEX_C),
            axilWriteSlave  => axilWriteSlaves(AXIL_REVSIG_CTRL_INDEX_C));
    ...
    U_AbortTrigs : entity work.AbortTrigs
        ...
        port map(
            ...
            axilClk         => axilClk,
            axilRst         => axilRst,
            axilWriteMaster => axilWriteMasters(AXIL_TRIGS_INDEX_C),
            axilWriteSlave  => axilWriteSlaves(AXIL_TRIGS_INDEX_C),
            axilReadMaster  => axilReadMasters(AXIL_TRIGS_INDEX_C),
            axilReadSlave   => axilReadSlaves(AXIL_TRIGS_INDEX_C));
